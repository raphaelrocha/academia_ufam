<a href="index.php?r=horario/admin">lista de horários preenchidos</a>
</br></br>

<?php

//$fuso = (4 * 60 * 60);
$model = Academia::model()->findByPk(3);
...
$totalRegistros=0;
$sqlInsert = "INSERT INTO HORARIO (ID, ID_ACADEMIA, DATADIA, DIASEMANA, PERIODO, HORAINICIO, HORAFIM, TOTAL_USO)
VALUES";
