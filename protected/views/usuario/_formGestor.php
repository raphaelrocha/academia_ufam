...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php $situacaoArray = array('ativo'=>'Ativo', 'inativo'=>'Inativo')?>

	<?php if($patenteModel!="diretor"):?>
		<div class="row">
			<?php echo CHtml::label('Situação.<font size="1" color="red"><b><i>*</i></b></font>', '',array('id'=>'labelSituacao')); ?>
			<?php echo $form->dropDownList($model,'SITUACAO',$situacaoArray, array('id'=>'CampoSituacao'/*,"disabled"=>"disabled", 'empty' => '--- Escolha um curso ---'*/)); ?>
		</div>
	<?php endif;?>
	...
	<?php if($patenteModel=="diretor"):?>
		<div class="row">
			<?php echo $form->hiddenField($model,'TIPO',array('size'=>20,'maxlength'=>20)); ?>
		</div>
		<div class="row">
			<?php echo $form->hiddenField($model,'SENHA',array('size'=>20,'maxlength'=>20)); ?>
		</div>
	<?php else: ?>
		<div class="row">
