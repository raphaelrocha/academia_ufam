...
class CursoController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				  'actions'=>array('create','update','index','view','admin','delete', 'ajuda'),
				'users'=>array('@'),
			),
			...
			try{
				...
				echo "
					<script type=\"text/javascript\">
						alert('O código do curso informado no campo Id Curso já existe. Escolha outro Código');
					</script>
				";
			}
		}
	...
	*/
	public function actionIndex()
	{
		...
		if($modelCurrentUser->TIPO != "aluno"){
